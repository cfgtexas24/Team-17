    ...
    return (
        <div className='flex flex-row justify-between mb-4'>
          ...
          <div className='flex flex-row justify-evenly'>
            ...
            <Link to="/profile" className='text-[#3d251e] font-semibold p-2 ml-2 mr-2 hover:text-white hover:bg-[#3a696e] hover:bg-opacity-65 rounded-lg'>Patient Management</Link>
